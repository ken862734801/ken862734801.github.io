        ...
        <main className='about-page' id='about-page'>
            <div className='about-container'>
                ...
                <div className='biography'>
                    <p> 
                        I am a Fullstack Developer, with a background in Biology, who is looking to pivot from previous healthcare aspirations towards a career in web development.
